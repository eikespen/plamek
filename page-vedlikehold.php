...
$h_t1   = pl_meta('pl_ved_hero_title1', 'Serviceavtale og');
$h_t2   = pl_meta('pl_ved_hero_title2', 'vedlikehold');
$h_desc = pl_meta('pl_ved_hero_desc',   'En serviceavtale med Plamek AS reduserer risikoen for uforutsette kostnader og driftsstans i bygget. Vi tilbyr skreddersydde avtaler for alle typer haller.');
$h_img  = pl_meta('pl_ved_hero_image',  get_template_directory_uri() . '/assets/images/vedlikehold.webp');

$off_title = pl_meta('pl_ved_off_title', 'Hva inngår i en serviceavtale?');
$off_intro = pl_meta('pl_ved_off_intro', 'Vi skreddersyr avtalen etter deres behov, men typiske elementer inkluderer:');
...
for ($i = 1; $i <= 6; $i++) {
    $offerings[] = [
        'title' => pl_meta("pl_ved_off{$i}_title", $offerings_defaults[$i][0]),
        'desc'  => pl_meta("pl_ved_off{$i}_desc",  $offerings_defaults[$i][1]),
    ];
}

$ben_title = pl_meta('pl_ved_ben_title', 'Fordeler med jevnlig vedlikehold');
$benefits_defaults = [
...
for ($i = 1; $i <= 4; $i++) {
    $benefits[] = [
        'title' => pl_meta("pl_ved_ben{$i}_title", $benefits_defaults[$i][0]),
        'desc'  => pl_meta("pl_ved_ben{$i}_desc",  $benefits_defaults[$i][1]),
    ];
}

$g1_title = pl_meta('pl_ved_g1_title', 'Ridehall før dukskift');
$g1_desc  = pl_meta('pl_ved_g1_desc',  'Gammel og slitt duk som trenger utskifting');
$g1_img   = pl_meta('pl_ved_g1_img',   '');
$g2_title = pl_meta('pl_ved_g2_title', 'Ridehall med ny duk');
$g2_desc  = pl_meta('pl_ved_g2_desc',  'Ferdig oppgradert hall med ny duk fra Plamek');
$g2_img   = pl_meta('pl_ved_g2_img',   '');

$cta_btn = pl_meta('pl_ved_cta_btn', 'Bestill service');
?>
...
<div class="min-h-screen bg-white">
    ...
    <section class="py-16 sm:py-20 bg-[#003a76]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl sm:text-4xl font-light text-white mb-6">Klar for å sikre hallen din?</h2>
